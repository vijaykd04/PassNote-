...
function Footer() {
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
        ...
        whileHover={{ rotateX: 6, rotateY: -6 }}
          ...
          style={{ transformStyle: "preserve-3d" }}>
            ...
            <p className="text-sm text-gray-300 max-w-sm">PassNotes AI helps students generate exam-focused notes,
 ...
 <div className='text-center'>
            ...
            <ul className='space-y-2 text-sm'>
                ...
                <li className='text-gray-300 hover:text-white transition-colors'>support@passnotes.ai</li>
            </ul>
        </div>
     ...
     <p className='text-center text-xs text-gray-500'>
        © {new Date().getFullYear()} PassNotes AI. All rights reserved.
     </p>
