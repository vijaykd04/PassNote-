...
function Notes() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      ...
      >
        <div onClick={() => navigate("/")} className='cursor-pointer'><h1 className='text-2xl font-bold
            ...
            bg-clip-text text-transparent'>PassNotes</h1>
    ...
    text-white text-sm' onClick={() => navigate("/pricing")}>
      ...
      <motion.div 
          className="mb-12">
        <TopicForm loading={loading} setResult={setResult} setLoading={setLoading} setError={setError} onTopicSubmit={setNoteTopic}/>
      </motion.div>
    ...
    transition={{ duration: 0.4 }}
     className='flex flex-col
      ...
      gap-6'>
        ...
        p-6'>
          <FinalResult result={result} topic={noteTopic}/>
